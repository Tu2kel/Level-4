...
// import AudioAbout from "./Zepp.mp3";
import AudioAbout from "./Reigns.mp3";
...
export default function AudioPlayer() {
  ...
  return (
    <div>
      {/* <h2>Audio Player</h2> */}
      <audio ref={audioRef} src={AudioAbout} autoPlay loop controls />
    </div>
  );
}
...
//     <div>
//       <h2>Audio Player</h2>
//       <audio ref={audioRef} src={AudioAbout} loop controls />
//     </div>
//   );
// }
